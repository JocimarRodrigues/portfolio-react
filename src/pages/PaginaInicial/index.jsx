      ...
      <section className={styles.sobre} id="conteudo">
        <motion.div className={styles.conteudo}>
          ...
          <p>
            ...
            pouco tempo, quando um amigo ingressou no mercado e me explicou como
            o mesmo funciona e a prática. Decidi me dedicar e tentar aprender e,
            quando o fiz, me identifiquei com a área. 
            <p>
            Programar acabou virando
            um hobby, fiquei fascinado em aprender novas linguagens e resolver
            problemas. Atualmente estou estudando com foco em me tornar dev
            Front-End, neste portfólio você poderá ver os projetos que
            desenvolvi até agora e poderá acompanhar minha evolução.
              </p>
          </p>
        </motion.div>
      </section>
